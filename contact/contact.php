...
<?php
    ...
    $to = "azelegna@gmail.com"; // Replace xxxx@xxxx.com with your email address (mandatory!) 
    $subject = "Quiero estar en contacto contigo"; // Choose a custom subject (not mandatory)

    $body = "Has recibido un mensaje de " . $name . " (" . $email . "):\n\n" . $message;

    $from = "From: azelegna.com"; // Replace "Beetle Template" with your site name (not mandatory)   
    $headers = "From:" . $from . "\r\n";
